...
Given n segments, it is necessary to find a set of points of minimum size, for which each of the segments contains at least one of the points.

The first line contains the number 10 <= n <= 100 segments. Each of the next nn lines contains two numbers 0 <= l <= r <= 10^90, defining the beginning and end of the segment. Output the optimal number m of points and the m points themselves. If there are several such sets of points, print any of them.
